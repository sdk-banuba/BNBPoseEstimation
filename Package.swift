...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-40-gb99e5d381/BNBPoseEstimation.zip",
            checksum: "84ac73b25906bcf59f52051a6499c4867fa6336374b4a63a78fb527b41a351ce"
        ),
        .target(
