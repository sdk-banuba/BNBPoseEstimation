...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.0-1-g971efc62f/BNBPoseEstimation.zip",
            checksum: "e8b55f5e5ea7b3ba2f4f9e0ce16db863dd47080a92847244575ae99ca9892674"
        ),
        .target(
