...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-35-g200bb3db4/BNBPoseEstimation.zip",
            checksum: "42c9e0f756c8d07debc14de5baa04a759ff256b02fab247d3d4af1492835c03e"
        ),
        .target(
