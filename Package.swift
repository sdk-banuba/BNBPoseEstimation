...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-66-g886631a577/BNBPoseEstimation.zip",
            checksum: "16aa152b5d925039b30adbf2e9e44732ffc405e66ad2fe0fe7329e87cb97245e"
        ),
        .target(
