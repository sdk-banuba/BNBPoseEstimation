...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-218-g91528edbf1/BNBPoseEstimation.zip",
            checksum: "744b8aee3bdac2ad3250cea74d8163cfa8972769260cc510e437569fcb8a663e"
        ),
        .target(
