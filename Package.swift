...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-177-gd98bf09f0/BNBPoseEstimation.zip",
            checksum: "4d0f8b904c7e131878c6ad2334549a93e74e577588041764eadbf14bc8665778"
        ),
        .target(
