...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBPoseEstimation.zip",
            checksum: "3a4dba1bb2b1f8c93c31da91f6255832110e335d72b0dda206ab2749a009456d"
        ),
        .target(
