...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.3-43-gc75a0b291/BNBPoseEstimation.zip",
            checksum: "24093c12da813fa32ce312f333db89e2c03ed493d228e4353f674dc90a2959f7"
        ),
        .target(
