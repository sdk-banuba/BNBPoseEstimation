...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-214-g5030d169c2/BNBPoseEstimation.zip",
            checksum: "e40cf8db3638e7abca203b881a15fd8ba9a02d9674f41f2cb2410fdebbd1513a"
        ),
        .target(
