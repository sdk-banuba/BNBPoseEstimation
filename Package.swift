...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-187-g0f5dcf5d80/BNBPoseEstimation.zip",
            checksum: "29053e7367514d3740580f91a56b1fd15d9f142cbdb756b332a9101d8e174dba"
        ),
        .target(
