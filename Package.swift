...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-69-g431d04ab4a/BNBPoseEstimation.zip",
            checksum: "269a251b194b1f767f461c4f8e3f9de2b08a6413b53a7d5ed1eeb327808e9e21"
        ),
        .target(
