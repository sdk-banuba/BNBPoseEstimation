...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-138-g40eb4c9af/BNBPoseEstimation.zip",
            checksum: "fd04add2d04e5aaac7c7701543e971e2d4a2840e7941cbf090ed3fa2fb972708"
        ),
        .target(
