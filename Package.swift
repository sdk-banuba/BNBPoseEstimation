...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-106-g81956e5c7/BNBPoseEstimation.zip",
            checksum: "eedbd6a3f11120ecd7b6b8114c49fac78e15ed8858a610f4914dfef815316b85"
        ),
        .target(
