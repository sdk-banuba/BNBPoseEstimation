...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBPoseEstimation.zip",
            checksum: "d6d1bdf77a655f9b0f0a7ea9c6f2882804ebd090f8a54ef3cc54f0555aaf712f"
        ),
        .target(
