...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBPoseEstimation.zip",
            checksum: "a10ea842f4760d5672ca9702f9fb61bcc65c3a39161c505ac4048e9bf9f913be"
        ),
        .target(
