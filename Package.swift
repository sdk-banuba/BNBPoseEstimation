...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-gcda6b9c4b/BNBPoseEstimation.zip",
            checksum: "46bad0bf464e0bf21861071122032b5214c6d99f5a15d3112e1d5892fa2174c0"
        ),
        .target(
