...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBPoseEstimation.zip",
            checksum: "715ff72621287476d32ceeeb45476c67aa2c90a8938b132b15f5a824ac60becb"
        ),
        .target(
