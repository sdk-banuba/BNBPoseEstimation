...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-271-g70b8136591/BNBPoseEstimation.zip",
            checksum: "efd898d2793aaaf2bb877f69fb201b0dcf3ff940b89e52b09ef8902a85af44b0"
        ),
        .target(
