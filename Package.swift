...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.0-8-g22fe376040/BNBPoseEstimation.zip",
            checksum: "23c25b31dc09f2af1e223f269e6e97a6ddfa80975eff3121a90a640d1391b9c2"
        ),
        .target(
