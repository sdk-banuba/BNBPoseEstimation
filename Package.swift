...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-175-g35e1b614c0/BNBPoseEstimation.zip",
            checksum: "99471fa006ced4bd42a3190d1a6a93389522d553381062bfca68c34769ff88c9"
        ),
        .target(
