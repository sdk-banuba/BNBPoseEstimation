...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBPoseEstimation.zip",
            checksum: "e3c49795eb5f15de8abe376363bbd35d730c1a432634f1fe3006c87b15590358"
        ),
        .target(
