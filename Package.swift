...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBPoseEstimation.zip",
            checksum: "948e76c8040e7808df4fc1decb57017a351a92870fbb649918ff72fbd007fc44"
        ),
        .target(
