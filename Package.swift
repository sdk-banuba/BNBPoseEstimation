...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-1-ge047381c9/BNBPoseEstimation.zip",
            checksum: "90f5d1be2fd4ef6dd5a2dab3bce9b0ed4ff537736e05e669fa61314cfc0bd035"
        ),
        .target(
