...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-242-g622cf17fa4/BNBPoseEstimation.zip",
            checksum: "87a61c5e6a1940a48676fd916db68e65ff3e2a1e128cc549b3f95a8c6e9443a8"
        ),
        .target(
