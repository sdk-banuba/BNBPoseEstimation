...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBPoseEstimation.zip",
            checksum: "b0fc434b6216625c25549055bcfbf5b03f992571e83874914069fc642e226663"
        ),
        .target(
