...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBPoseEstimation.zip",
            checksum: "285f0ef599772465c4b226ae0b318cfa1d32c75c763e01783000291956731e75"
        ),
        .target(
