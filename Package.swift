...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-33-g2b785861d0/BNBPoseEstimation.zip",
            checksum: "3da664ddfab8fe820ee60241013bfa4038212961b81522653ca9f54a667bb8aa"
        ),
        .target(
