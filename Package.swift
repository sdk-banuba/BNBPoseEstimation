...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBPoseEstimation.zip",
            checksum: "9a3f1f340801b0acba4fa4465c99a71d1969f50c746b10f5ae235c55a12c08f1"
        ),
        .target(
