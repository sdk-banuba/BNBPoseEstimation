...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.4-99-gef5d08583/BNBPoseEstimation.zip",
            checksum: "d8d50ea2d9215f35594ae61d17f4dbda9e4c21e1454173d63e5eef0c64b32621"
        ),
        .target(
