...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g2a72d3010f/BNBPoseEstimation.zip",
            checksum: "3eab7ebc467e90982130ccefe22fce41f40882106c5ec91d9a5e0fdc23b778f3"
        ),
        .target(
