...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-147-gb1b24af02/BNBPoseEstimation.zip",
            checksum: "f437e90981268cb055f7c27bda876f62f602eaeff7a754499f1f47c55fa87e5d"
        ),
        .target(
