...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBPoseEstimation.zip",
            checksum: "d1ca38c1fb3b58ac78f11f5bfd0534440083ab12d8f38200fae95582cca8e465"
        ),
        .target(
