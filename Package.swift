...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBPoseEstimation.zip",
            checksum: "3cf9e7622b6cd8aa0279c35a6bf580f6fff92629c323f012a7e170c283e6fffc"
        ),
        .target(
