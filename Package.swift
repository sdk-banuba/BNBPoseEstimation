...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g079acbf0ae/BNBPoseEstimation.zip",
            checksum: "9544de13eeba66d08c6f447825f4cedc2c5f46b85a9638247af6d0bc39281f7c"
        ),
        .target(
