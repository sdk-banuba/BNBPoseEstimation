...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-74-g9d1b0a47e/BNBPoseEstimation.zip",
            checksum: "ef0d4e3b0aa3d01099e4bf02dc334ab0c03a38620edde3ac376e50463c972b0a"
        ),
        .target(
