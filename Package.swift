...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBPoseEstimation.zip",
            checksum: "13fec01f539cce5bde9f7b2e52705ec56a9afd040a7b6c779fa66cf2e0e4156f"
        ),
        .target(
