...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBPoseEstimation.zip",
            checksum: "c3a926ff7082e4943924fe72550ea7e774c6ab642985957df64811e8759866f4"
        ),
        .target(
