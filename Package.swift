...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBPoseEstimation.zip",
            checksum: "4ba35d7f39498296db752f77d17ae8091a3a62c1013f4530f94c11963a219c81"
        ),
        .target(
