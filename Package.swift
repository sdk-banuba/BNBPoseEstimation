...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-204-g6de1b78ed5/BNBPoseEstimation.zip",
            checksum: "d3ea20183f4643468a9ae6c1303bfeb85fda6e5101e027a8a98c14e503ddbc86"
        ),
        .target(
