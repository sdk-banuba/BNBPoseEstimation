...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-75-g381c51d93/BNBPoseEstimation.zip",
            checksum: "e7d0af2cdcdf56befbcb2fc1f0cb0f3b584d2133315cfa3818eb8041cdf38d4c"
        ),
        .target(
