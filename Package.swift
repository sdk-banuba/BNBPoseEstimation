...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.6-65-gbf994362d5/BNBPoseEstimation.zip",
            checksum: "be5d007bf81db9ee07b0dc5a73c252faf7beafb2a774e2c2dfc7875fa0803aa9"
        ),
        .target(
