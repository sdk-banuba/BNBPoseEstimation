...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBPoseEstimation.zip",
            checksum: "b73953b2ac0cf3dd9afc12206b33f2e03fd81e46f9b0844c9404b366641f9581"
        ),
        .target(
