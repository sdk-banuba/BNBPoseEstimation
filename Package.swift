...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBPoseEstimation.zip",
            checksum: "f1e1c0466f9a2eaa7d033597512b4d409ca1c52f31fc4d5b062f552e1e342d07"
        ),
        .target(
