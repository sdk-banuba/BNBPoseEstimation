...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.0-3-gb365c1950/BNBPoseEstimation.zip",
            checksum: "dfd319141555264c752d3a926ccf56c441bebc605dc50dda36339983f6ef4a25"
        ),
        .target(
