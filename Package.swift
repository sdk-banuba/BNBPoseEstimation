...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-g26e50cae8/BNBPoseEstimation.zip",
            checksum: "907f6a8683c91de6fd3ccb95b33382bf2036d720241a10c00d19e26e70f1f365"
        ),
        .target(
