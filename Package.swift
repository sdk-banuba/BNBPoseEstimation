...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBPoseEstimation.zip",
            checksum: "66e1348424efd4ededb4be0392e2850cd10dd5dd31148a05c3e7aab5ca94a19b"
        ),
        .target(
