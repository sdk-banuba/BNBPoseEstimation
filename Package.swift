...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBPoseEstimation.zip",
            checksum: "5216dca21dd7703ac8a5bdb14af6f5c3b54971412cf97aaceb90c90723b983ac"
        ),
        .target(
