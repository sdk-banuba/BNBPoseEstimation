...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBPoseEstimation.zip",
            checksum: "3b09967fafdfd744590d62c0cb0318f6cfe945bb065f51c1a6d936a552ae6bcd"
        ),
        .target(
