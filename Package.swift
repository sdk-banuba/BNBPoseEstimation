...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBPoseEstimation.zip",
            checksum: "5a063b3220e7d985f218ce91d8229c75c2f99a7d240ed55f6e84cda6141f54b8"
        ),
        .target(
