...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBPoseEstimation.zip",
            checksum: "247ea1a5a468b6a0f0992ff6f8f2cfe6d24b56b1d7264aa4b07ae358690f4caf"
        ),
        .target(
