...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.1-32-gc91d258b34/BNBPoseEstimation.zip",
            checksum: "a0fd1e395fd636f044e81cab312b6a34e1be3b599c1ab8d9958bd8da31ad860f"
        ),
        .target(
