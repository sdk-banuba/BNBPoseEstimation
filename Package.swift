...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBPoseEstimation.zip",
            checksum: "1e913f3045c70bbaa9cf6c7d260458c6bd1fecb516d93e735a3023009a1e9a00"
        ),
        .target(
