...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBPoseEstimation.zip",
            checksum: "67d8bd8e11ca2d96faf434992bf4360782495a2ff8f2d80f2dd2cf5f25478ab3"
        ),
        .target(
