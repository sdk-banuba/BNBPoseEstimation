...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBPoseEstimation.zip",
            checksum: "28f19a85ce5f0b3885d8440def058fecfc28c95f92343a2cf29f4464c7333ab7"
        ),
        .target(
