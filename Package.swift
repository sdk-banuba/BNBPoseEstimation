...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBPoseEstimation.zip",
            checksum: "96838f35189b97159f574f3cde43eb65dbf0658800c300d39d8529d39bad325d"
        ),
        .target(
