...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBPoseEstimation.zip",
            checksum: "49a60ca9310acffd373c46a6d89ff86778f477e00225c29ad53fa82a2969b763"
        ),
        .target(
